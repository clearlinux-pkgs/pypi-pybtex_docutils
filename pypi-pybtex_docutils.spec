...
%prep
%setup -q -n pybtex-docutils-1.0.3
cd %{_builddir}/pybtex-docutils-1.0.3
pushd ..
cp -a pybtex-docutils-1.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692833519
...
cp %{_builddir}/pybtex-docutils-%{version}/LICENSE.rst %{buildroot}/usr/share/package-licenses/pypi-pybtex_docutils/b060e9b6372c36f719c9b9f2ccff3fd48c732512 || :
